...
pub enum SyntaxError {
    ...
    #[fail(display = "{} expected", _1)] Expecting(Location, String),

    #[fail(display = "{} not expected", _1)] NotExpecting(Location, String),
    ...
    // Thanks, OCaml...
    #[fail(display = "syntax error")] Other(Location),

    #[fail(display = "ill-formed ast: {}", _1)] IllFormedAst(Location, String),
